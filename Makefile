...
RAYLIB_INCLUDE_PATH   ?= third_party/raylib
RAYLIB_LIB_PATH       ?= third_party/raylib
...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH) -I$(RAYLIB_PATH)/src/external -I$(RAYLIB_PATH)/src/extras
