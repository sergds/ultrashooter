...
void AlsoStartGameState::Think()
{
	...
	Vector2 pos{ 0,0 };
	//DrawTextEx(DefaultFont, "������ SergDS", CLITERAL(Vector2) { 280, 280 }, 40, 1, WHITE);
	...
	if (m_tics == 200) {
		//DrawTextEx(DefaultFont, "��� ����� ������ ������ ����!", CLITERAL(Vector2) { 100, (10 * (float)sin(GetTime() * 2) + 320) }, 40, 1, WHITE);
		//int count = 0;
		//int* codepoints = LoadCodepoints("��� ����� ������ ������ ����!", &count);
